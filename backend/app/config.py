...
_COMMON_BLOCK = [
    "렌탈", "월렌탈", "렌탈료", "기기변경", "요금제", "개통", "의류", "옷",
    "중고", "중고급매", "리퍼", "리퍼브", "전시상품", "전시제품", "반품상품",
]
...
CATEGORY_RULES = {
    ...
    "헤어드라이어": {
        "must": ["헤어드라이어", "드라이기"],
        "block": _COMMON_BLOCK + [
            "부품", "필터", "소모품", "케이스", "파우치", "거치대",
        ],
        "min_price": 15000,
    },
    "헤어스타일러": {
        "must": ["헤어스타일러", "고데기", "매직기", "컬러기", "에어랩"],
        "block": _COMMON_BLOCK + [
            "부품", "소모품", "집게", "모근핀", "가르마펌", "클립", "롤", "빗",
        ],
        "min_price": 20000,
    },
    "사운드바": {
        "must": ["사운드바"],
        "block": _COMMON_BLOCK + [
            "거치대", "브라켓", "케이블", "리모컨", "부품", "소모품",
        ],
        "min_price": 50000,
    },
    "블루투스 스피커": {
        "must": ["블루투스 스피커", "블루투스스피커"],
        "block": _COMMON_BLOCK + [
            "케이스", "파우치", "거치대", "스트랩", "부품", "안마의자",
        ],
        "min_price": 15000,
    },
    "프로젝터": {
        "must": ["프로젝터"],
        "block": _COMMON_BLOCK + [
            "스크린", "거치대", "리모컨", "램프", "부품", "소모품",
        ],
        "min_price": 50000,
    },
    "커피머신": {
        "must": ["커피머신", "커피메이커", "에스프레소머신"],
        "block": _COMMON_BLOCK + [
            "캡슐", "원두", "필터", "청소", "부품", "소모품", "디스케일러",
        ],
        "min_price": 30000,
    },
    "믹서기": {
